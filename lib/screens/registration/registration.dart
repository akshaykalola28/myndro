            ...
            child: GestureDetector(
              ...
              child: Stack(
                children: [
                  Positioned(
                      top: 0,
                      child: Image.asset(ImagePath.semiGreenBlue,width: Get.width*0.95,height: 150,fit: BoxFit.fill,)),
                  Align(
                    alignment: Alignment.bottomCenter,
                    child: Container(
                      height: Get.height * 0.72,
                      width: Get.width,
                      padding: EdgeInsets.fromLTRB(Get.width * 0.12, Get.width * 0.09, Get.width * 0.12, 0),
                              ...
                              Align(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: ()=>Get.offAndToNamed(LoginScreen.pageId),
                                      child: Text(
                                        "Login",
                                        style: TextStyle(
                                          fontFamily: AppTextStyle.microsoftJhengHei,
