            ...
            child: GestureDetector(
              ...
              child: Stack(
                children: [
                  Positioned(
                      top: 0,
                      child: Image.asset(ImagePath.semiGreenBlue,width: Get.width*0.9,height: 120,fit: BoxFit.fill,)),
                 /* Align(
                 ...
                 bottom: 0,
                    right: 0,
                    child: Image.asset(ImagePath.cornerGreenBlue,width: Get.width*0.9,height: 300,fit: BoxFit.fill,),
                  ),
                  Positioned(
                 bottom: 82,
                    right: 15,
